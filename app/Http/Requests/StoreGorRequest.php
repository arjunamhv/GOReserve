...
class StoreGorRequest extends FormRequest
{
    ...
    {
        return [
            'inpgorbanner' => 'required|image|mimes:png,jpg,jpeg|max:2048',
            'inpgorphotos'=> 'required|array|min:1',
    ...
    {
        return [
            'inpgorbanner.required' => ':attribute harus diisi',
            ...
            'inpgorphotos.required' => ':attribute harus diisi',
