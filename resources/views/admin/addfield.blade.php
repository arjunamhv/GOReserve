        ...
        <form method="POST" action="{{ url('field') }}" enctype="multipart/form-data">
            ...
            <div class="my-5">
                <label for="fieldbanner" class="label">
                    <span class="label-text">Add Field Banner</span>
                </label>
            ...
            <div class="form-control my-5">
                ...
                <input type="text" name="inpfieldname" placeholder="Type here" value="{{ old('inpfieldname') }}"
            ...
            <div class="form-control my-5">
                ...
                <select name="inpfieldtype" id="fieldtype"
                    ...
                    <option value="{{ $type->id }}" {{ old('inpfieldtype') == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                    @endforeach
                </select>
                @error('inpfieldtype')
                    <div class="text-error">{{ $message }}</div>
            ...
            <input type="hidden" name="gor_id" value="{{ $gor->id }}">
            <button type="submit" class="btn btn-block btn-primary my-2">Add Field</button>
        </form>
    </div>
