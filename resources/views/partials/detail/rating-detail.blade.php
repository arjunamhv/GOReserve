...
@section('content')
    <section class="py-12">
        <div class="w-full px-6 lg:px-32">
            <a href="/myticket" class="text-sm lg:text-lg mb-5 lg:mb-0 font-semibold text-sky-800 flex items-center hover:opacity-50 transition duration-300 ease-in-out "><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-left-short" viewBox="0 0 16 16">
