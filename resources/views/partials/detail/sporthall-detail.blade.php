    ...
    <section class="py-36 px-32">
        ...
        <div class="flex justify-start my-5">
            <div class="w-1/2">
                ...
                <p class="text-xl font-medium text-slate-800 my-2">{{ $gor->opening_hour }} WIB</p>
            </div>
            <div class="w-1/2">
                ...
                <p class="text-3xl text-sky-900 font-bold mt-3">Rp. {{ number_format($gor->price, 2, ',', '.') }}</p>
            </div>
        </div>
        <div class="w-full pt-5 border-t border-slate-700">
        <a href="/sporthall/{{ $gor->name }}/order" class="text-lg font-bold text-white bg-sky-800 py-3 px-24 rounded-2xl hover:shadow-lg hover:opacity-50 transition duration-300 ease-in-out">ORDER</a>
        </div>
    </section>
@endsection