...
@section('content')
    ...
    <section class="md:flex flex-row justify-between items-center flex-wrap my-5 px-32" id="section2">
    ...
    <section class="md:flex flex-row justify-between items-center flex-wrap px-32">
    ...
    <section class="my-5 mt-10 px-32">
