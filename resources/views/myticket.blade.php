            ...
            @foreach ($payment as $ticket)
                ...
                <div class="mx-auto w-full lg:w-[80%] mb-10">
                    <div class="border border-slate-300 rounded-lg shadow-md p-4 flex justify-between items-center">
                        ...
                        <img src="{{ asset('storage/images/fieldbanner/' . $ticket->booking->field->field_banner) }}" alt="{{ $ticket->booking->field->field_banner }}" class="hidden lg:block mr-10 w-[300px] h-[200px] rounded-xl">
                            <div>    
